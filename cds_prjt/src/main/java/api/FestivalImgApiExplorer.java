...
public class FestivalImgApiExplorer {
    public static <T extends Object> T getApiJsonData( String serviceKey, String srcUrl, String pageNo, String numOfRows,
        ...
        urlBuilder.append("&" + URLEncoder.encode("imageYN","UTF-8") + "=" + URLEncoder.encode("Y", "UTF-8")); /*이미지조회:콘텐츠이미지조회*/
        urlBuilder.append("&" + URLEncoder.encode("subImageYN","UTF-8") + "=" + URLEncoder.encode("Y", "UTF-8")); /*이미지URL불러오기*/
